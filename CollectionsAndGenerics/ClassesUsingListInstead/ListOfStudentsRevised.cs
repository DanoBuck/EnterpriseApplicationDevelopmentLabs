...
namespace CollectionsAndGenerics.ClassesUsingListInstead
{
    public class ListOfStudentsRevised
    {
        public int ID { get; set; }
        public string LecturerName { get; set; }
        public List<Student> StudentArrayList { get; set; }

        public ListOfStudentsRevised()
        {
            ID = 0;
            LecturerName = "";
